...
project.getProjectPagesAsTXT([MMDAQueryConstants_1.pages.ID, MMDAQueryConstants_1.pages.NAME, MMDAQueryConstants_1.pages.TYPE, MMDAQueryConstants_1.pages.LAYOUT, MMDAQueryConstants_1.pages.ALLOWEDROLES, MMDAQueryConstants_1.pages.URL], [], [new MMDA.Sorter(MMDAQueryConstants_1.pages.NAME, false)], "./pagesDSC.txt");
project.getProjectPagesAsTXT([MMDAQueryConstants_1.pages.ID, MMDAQueryConstants_1.pages.NAME, MMDAQueryConstants_1.pages.TYPE, MMDAQueryConstants_1.pages.LAYOUT, MMDAQueryConstants_1.pages.ALLOWEDROLES, MMDAQueryConstants_1.pages.URL], [], [new MMDA.Sorter(MMDAQueryConstants_1.pages.NAME, true)], "./pagesASC.txt");
