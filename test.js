...
var MMDAQueryConstants_3 = require("./MMDAQueryConstants");
...
project.getProjectDocumentsAsXML([MMDAQueryConstants_1.documents.ID, MMDAQueryConstants_1.documents.NAME, MMDAQueryConstants_1.documents.TYPE, MMDAQueryConstants_1.documents.CONTAINER], [new MMDA.Filter(MMDAQueryConstants_1.documents.NAME, "Testapp")], [MMDAQueryConstants_1.documents.TYPE, MMDAQueryConstants_1.documents.NAME], "./Documents.xml"); //filtered Result with sorting
project.getProjectConstantsAsXML([MMDAQueryConstants_2.constants.ID, MMDAQueryConstants_2.constants.NAME, MMDAQueryConstants_2.constants.TYPE, MMDAQueryConstants_2.constants.DATATYPE, MMDAQueryConstants_2.constants.DATAVALUE], [], [], "./Constants.xml");
project.getProjectDomainModelsAsXML([MMDAQueryConstants_3.domainmodels.ID, MMDAQueryConstants_3.domainmodels.TYPE, MMDAQueryConstants_3.domainmodels.ENTITIES, MMDAQueryConstants_3.domainmodels.ASSOCIATIONS], [], [], "./domainmodels.xml");
...
project.getModuleDocumentsAsXML("Testapp", [MMDAQueryConstants_1.documents.ID, MMDAQueryConstants_1.documents.NAME, MMDAQueryConstants_1.documents.TYPE, MMDAQueryConstants_1.documents.CONTAINER], [], [], "./ModuleDocuments.xml");
project.getFolderDocumentsAsXML("00 Common", [MMDAQueryConstants_1.documents.ID, MMDAQueryConstants_1.documents.NAME, MMDAQueryConstants_1.documents.TYPE, MMDAQueryConstants_1.documents.CONTAINER], [], [], "./FolderDocuments.xml");
