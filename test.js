...
project.getFolderMicroflowsAsXML("00 Common", [MMDAQueryConstants_1.microflows.ID, MMDAQueryConstants_1.microflows.NAME, MMDAQueryConstants_1.microflows.TYPE, MMDAQueryConstants_1.microflows.CONTAINER, MMDAQueryConstants_1.microflows.RETURNTYPE], [], [], "./Foldermicroflows.xml");
project.getModuleMicroflowsAsXML("Testapp", [MMDAQueryConstants_1.microflows.ID, MMDAQueryConstants_1.microflows.NAME, MMDAQueryConstants_1.microflows.TYPE, MMDAQueryConstants_1.microflows.CONTAINER, MMDAQueryConstants_1.microflows.RETURNTYPE], [], [], "./Modulemicroflows.xml");
