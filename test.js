...
project.getFolderLayoutsAsXML("00 Common", [MMDAQueryConstants_1.layouts.ID, MMDAQueryConstants_1.layouts.NAME, MMDAQueryConstants_1.layouts.TYPE, MMDAQueryConstants_1.layouts.CONTAINER, MMDAQueryConstants_1.layouts.LAYOUTTYPE], [], [], "./Folderlayouts.xml");
project.getModuleLayoutsAsXML("Testapp", [MMDAQueryConstants_1.layouts.ID, MMDAQueryConstants_1.layouts.NAME, MMDAQueryConstants_1.layouts.TYPE, MMDAQueryConstants_1.layouts.CONTAINER, MMDAQueryConstants_1.layouts.LAYOUTTYPE], [], [], "./Modulelayouts.xml");
